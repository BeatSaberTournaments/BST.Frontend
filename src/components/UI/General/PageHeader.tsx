...
export default function PageHeader({ title }: { title: string }) {
  ...
  return (
    <span className="bannerDiv rounded-md opacity-0 bg-gradient-to-r from-gray-600 dark:from-gray-700 text-white h-[70px] pl-6 mb-5 flex justify-start items-center transition-all drop-shadow-[-2px_0_1px_rgba(0,0,0,0.20)]">
