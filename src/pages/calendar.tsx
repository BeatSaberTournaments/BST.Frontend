    ...
    <>
      ...
      <div className="max-w-[1340px] mx-auto pt-10 px-4 sm:px-6 lg:px-8">
        ...
        {load ? (
          ...
          <>
            <div className="calendarDiv bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg divide-y divide-gray-200 transition-all opcaity-0">
              <div className="px-4 py-5 sm:px-6">
                <p className="rulesInfoHeader">The calendar</p>
                <p className="text-gray-900 dark:text-white text-[18px] mt-2">
                  Shows previous and upcoming events.
                </p>
              </div>
