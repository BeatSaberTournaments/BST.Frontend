...
/**
 * @swagger
 * /api/tournaments/mods:
 *   get:
 *     description: Returns the list of mods banned from tournaments hosted by BST.
 *     responses:
 *       200:
...
export default async function getAllBannedMods(req: NextApiRequest, res: NextApiResponse) {
    try {
